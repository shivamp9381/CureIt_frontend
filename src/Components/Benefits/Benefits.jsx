    ...
    <div className={styles.container}>
      ...
      <ul className={styles.benefitsList}>
        <li className={styles.text}>
          ...
          <p>
            Competent and faster treatment by experienced doctors, even in an
            emergency
          </p>
        </li>
        <li className={styles.text}>
          ...
          <p>24/7 digital, simple and quick access</p>
        </li>
        <li className={styles.text}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <p>Highest quality, thanks to doctors trained in telemedicine and
          recognized medical guidelines</p>
        </li>
        <li className={styles.text}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <li className={styles.text}>
          ...
          <p>Offsetting through health insurance</p>
        </li>
        <li className={styles.text}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <p>Costs and time savings (no directions or waiting times on site)</p>
        </li>
        <li className={styles.text}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
